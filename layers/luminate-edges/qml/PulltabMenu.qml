...
Item {
    ...
    // === THE FIX ===
    // Maps the 'luminateEdge' variable to this component's parent 
    // so it can safely read/write the parent's 'isPinned' property.
    property var luminateEdge: parent
    
    property real targetX: 0
    property real clampedX: Math.max(0, Math.min(targetX, parent.width - baseWidth))
    x: clampedX
    ...
    Rectangle {
        ...
        // Protect menu content from the fullscreen dismiss layer
        MouseArea { 
            anchors.fill: parent
            hoverEnabled: true 
        }
    ...
    Item {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    MouseArea { 
                        ...
                        onClicked: {
                            luminateEdge.isPinned = !luminateEdge.isPinned;
                        }
                    }
                }
            }
            ...
            GridLayout {
                ...
                SettingsBtn { 
                    iconStr: ""
                    labelStr: "MPRIS"
                    cmdStr: "aurora-shell --toggle mpris-player" 
                }
                
                SettingsBtn { 
                    iconStr: ""
                    labelStr: "Insight"
                    cmdStr: "aurora-shell --toggle insight" 
                }
                
                SettingsBtn { 
                    iconStr: ""
                    labelStr: "Cheatsheet"
                    cmdStr: "aurora-shell --toggle cheatsheet" 
                }
                
                SettingsBtn { 
                    iconStr: ""
                    labelStr: "Thinkfan"
                    cmdStr: "aurora-shell --toggle thinkfan" 
                }
            }
            ...
            GridLayout {
                ...
                SettingsBtn { 
                    iconStr: "󰍃"
                    labelStr: "Log Out"
                    cmdStr: "hyprctl dispatch exit" 
                }
                
                SettingsBtn { 
                    iconStr: "󰒲"
                    labelStr: "Sleep"
                    cmdStr: "systemctl suspend" 
                }
                
                SettingsBtn { 
                    iconStr: ""
                    labelStr: "Reboot"
                    cmdStr: "systemctl reboot" 
                }
                
                SettingsBtn { 
                    iconStr: ""
                    labelStr: "Shut Down"
                    cmdStr: "systemctl poweroff" 
                }
            }
        }
        ...
        Column {
            ...
            Repeater {
                ...
                // EXACT TEST VERSION INSTANTIATION
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            if (control.audioMenuType === "sink") {
                                AudioBackend.setSink(modelData.id);
                            } else if (control.audioMenuType === "source") {
                                AudioBackend.setSource(modelData.id);
                            } else if (control.audioMenuType === "player") {
